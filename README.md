...
It is divided into two diferent models:
  ...
  Sequence annotation model: It was trained a convolutional NN model to predict the GO terms based on the sequence. The embeded space values were to extract per sequence.
